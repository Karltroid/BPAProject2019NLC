var itempage, itemgallery;
var items = 
[
	[
		// food items - title, desc, site link, map, location, times, images...
		['Old Ebbitt Grill', 'Iconic tavern offering American meals, including popular oyster specials, in Victorian-style digs.', 'https://www.ebbitt.com/', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3105.1343824091286!2d-77.03544908523939!3d38.898042179570545!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!3m2!1sen!2sus!4v1553614542800', '675 15th St NW Washington, DC 20005', '7:30am-2:00am(mon-thu)<br />7:30am-3:00am(fri)<br />8:30am-3:00am(sat)<br />8:30am-2:00am(sun)','images/food/items/OldEbbittGrill/1.jpg', 'images/food/items/OldEbbittGrill/2.jpg', 'images/food/items/OldEbbittGrill/3.jpg', 'images/food/items/OldEbbittGrill/4.jpg', 'images/food/items/OldEbbittGrill/5.jpg'],
		...
		['Logan Tavern', 'Casual American eatry with a modern tavern feel, known for pre-theater dining & Sunday brunch. (vegan friendly)', 'https://www.logantavern.com/', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3104.620800172237!2d-77.0348886852389!3d38.90978597956869!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!3m2!1sen!2sus!4v1553615643332', '1423 P St NW, Washington, DC 20005', 'time open','images/food/items/LoganTavern/1.jpg']
	],
	[
...
function loaditem(itemtype, item)
{
	...
	for (var i in items[itemtype])
	{
		if (items[itemtype][i][0] == item)
		{
			...
			itempage.getElementsByTagName("li")[1].innerHTML = items[itemtype][i][5];

			for (var j = 6; j <= items[itemtype][i].length-1; j++)
			{
