...
[
	[
		// food items - title, desc, map, location, times, images
		['Old Ebbitt Grill', 'Iconic tavern offering American meals, including popular oyster specials, in Victorian-style digs.', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3105.1343824091286!2d-77.03544908523939!3d38.898042179570545!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!3m2!1sen!2sus!4v1553614542800', '675 15th St NW Washington, DC 20005', '7:30am-2:00am(mon-thu)<br />7:30am-3:00am(fri)<br />8:30am-3:00am(sat)<br />8:30am-2:00am(sun)','images/food/items/OldEbbittGrill/1.jpg', 'images/food/items/OldEbbittGrill/2.jpg', 'images/food/items/OldEbbittGrill/3.jpg', 'images/food/items/OldEbbittGrill/4.jpg', 'images/food/items/OldEbbittGrill/5.jpg'],
	...
	[
		// place items - title, desc, map, location, times, images
...
function loaditem(itemtype, item)
{
	...
	for (var i in items[itemtype])
	{
		if (items[itemtype][i][0] == item)
		{
			...
			itempage.getElementsByTagName("iframe")[0].src = items[itemtype][i][2];
			itempage.getElementsByTagName("li")[0].innerHTML = items[itemtype][i][3];
			itempage.getElementsByTagName("li")[1].innerHTML = items[itemtype][i][4];

			for (var j = 5; j <= items[itemtype][i].length-1; j++)
			{
